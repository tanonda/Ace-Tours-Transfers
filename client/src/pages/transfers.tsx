        ...
        <div className="container mx-auto px-4 pt-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {transfers.map((transfer, index) => (
              <div key={index} className="bg-card rounded-xl shadow-sm overflow-hidden border border-border flex flex-col">
                ...
                <div className="p-8 flex-grow flex flex-col">
                  ...
                  <p className="text-muted-foreground mb-6">{transfer.description}</p>
