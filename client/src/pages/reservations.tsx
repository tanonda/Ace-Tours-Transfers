          ...
          <CardContent className="p-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
               <div className="space-y-2">
                 ...
                 <Input placeholder="Confirmation number" className="h-12" />
               </div>
               ...
               <div className="space-y-2">
                 ...
                 <Input placeholder="Verification" className="h-12" />
               </div>
             </div>

             <div className="flex gap-4">
               <Button className="h-12 px-8 text-base bg-white border-2 border-[#004165] text-[#004165] hover:bg-[#004165] hover:text-white transition-colors gap-2">
                 <Search className="h-4 w-4" /> Search
               </Button>
               <Button variant="outline" className="h-12 px-8 text-base border-destructive text-destructive hover:bg-destructive hover:text-white transition-colors gap-2">
