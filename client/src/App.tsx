  ...
  useEffect(() => {
    fetch("/api/public/analytics-config")
      ...
      .then(({ ga4MeasurementId, gtmContainerId }) => {
        ...
        // Google Tag Manager
        if (isValidGtmId(normalizedGtmContainerId) && !document.getElementById("gtm-script")) {
        ...
        if (isValidGa4Id(normalizedGa4MeasurementId) && !isValidGtmId(normalizedGtmContainerId) && !document.getElementById("ga4-script")) {
